...
#ifndef LLVM_LIB_TRANSFORMS_INSTCOMBINE_ANNOINSTCOMBINEINTERNAL_H
#define LLVM_LIB_TRANSFORMS_INSTCOMBINE_ANNOINSTCOMBINEINTERNAL_H
...
namespace llvm {
    ...
    private:
        ...
        //Recode the delta info
        PerturbationMap &perturbation_map_;
        
        //BasicBlock where delta inserts into
        IRBuilder<> &delta_builder_;
        
    public:
        InstCombiner(InstCombineWorklist &Worklist, BuilderTy &Builder,
                     bool MinimizeSize, bool ExpensiveCombines, AliasAnalysis *AA,
                     AssumptionCache &AC, TargetLibraryInfo &TLI, DominatorTree &DT,
                     const DataLayout &DL, LoopInfo *LI, PerturbationMap &perturbation_map, IRBuilder<> &delta_builder)
        : Worklist(Worklist), Builder(Builder), MinimizeSize(MinimizeSize),
        ExpensiveCombines(ExpensiveCombines), AA(AA), AC(AC), TLI(TLI), DT(DT),
        DL(DL), SQ(DL, &TLI, &DT, &AC), LI(LI),MadeIRChange(false), perturbation_map_(perturbation_map), delta_builder_(delta_builder){}
    ...
    public:
        ...
        Instruction *replaceInstUsesWith(Instruction &I, Value *V) {
            ...
            //**** update delat info of I in delta_info_map ******
            auto it = perturbation_map_.find(&I);
            if(it != perturbation_map_.end()){
                perturbation_map_[V] = perturbation_map_[&I];
            }
            //******************************************************
            return &I;
        }
